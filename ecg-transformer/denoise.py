...
# From
# https://github.com/ajayarunachalam/Deep_XF/blob/main/blog_examples/denoising_signals/cli_ecg_application/denoise.py
...
def wavelet_denoising(x, wavelet='sym11', level=1):
